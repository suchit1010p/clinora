...
import { getAppointmentSummaryController, deleteAppointmentSummaryController, generateAppointmentSummaryController } from "../controllers/AiSummaryGenerater.js";
...
router.post("/:appointmentId/summary", verifyDoctorJWT, generateAppointmentSummaryController)
router.delete("/:appointmentId/summary", verifyDoctorJWT, deleteAppointmentSummaryController)
